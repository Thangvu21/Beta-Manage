            ...
            <Modal
                ...
                <View className="bg-white rounded-lg shadow-lg p-4">
                    <View className="flex-row items-center justify-between mb-4">
                        ...
                        <TouchableOpacity onPress={() => { setModalDeleteVisible(false) }} className="bg-gray-200 rounded-full p-2">
                            <Text className="text-red-500">X</Text>
                        </TouchableOpacity>
                    </View>
                    <Text className="text-gray-700">Bạn có chắc chắn muốn xóa món ăn {food?.name} không?</Text>
                    <View className="flex-row justify-end mt-4">
                        <TouchableOpacity onPress={() => handleDelete()} className="bg-red-500 text-white px-4 py-2 rounded-lg mr-2">
                            <Text className="text-white">Xóa</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => { setModalDeleteVisible(false)}} className="bg-gray-300 text-black px-4 py-2 rounded-lg">
